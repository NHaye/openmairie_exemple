...
$ent=_('om_lettretype_om_sql');
$reqmo['sql']="select  [om_lettretype], [om_collectivite], [id], [libelle], [actif], [orientation], [format], [logo], [logoleft], [logotop], [titre_om_htmletat], [titreleft], [titretop], [titrelargeur], [titrehauteur], [titrebordure], [corps_om_htmletatex], [margeleft], [margetop], [margeright], [margebottom], [se_font], [se_couleurtexte] from ".DB_PREFIXE."om_lettretype where om_sql = '[om_sql]' order by [tri]";
...
$reqmo['tri']=array('om_lettretype','om_collectivite','id','libelle','actif','orientation','format','logo','logoleft','logotop','titre_om_htmletat','titreleft','titretop','titrelargeur','titrehauteur','titrebordure','corps_om_htmletatex','margeleft','margetop','margeright','margebottom','se_font','se_couleurtexte');
?>
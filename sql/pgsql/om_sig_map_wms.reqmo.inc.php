...
$ent=_('om_sig_map_wms');
$reqmo['sql']="select  [om_sig_map_wms], [om_sig_wms], [om_sig_map], [ol_map], [ordre], [visibility], [panier], [pa_nom], [pa_layer], [pa_attribut], [pa_encaps], [pa_sql], [pa_type_geometrie], [sql_filter], [baselayer], [singletile], [maxzoomlevel] from ".DB_PREFIXE."om_sig_map_wms  order by [tri]";
...
$reqmo['tri']=array('om_sig_map_wms','om_sig_wms','om_sig_map','ol_map','ordre','visibility','panier','pa_nom','pa_layer','pa_attribut','pa_encaps','pa_sql','pa_type_geometrie','sql_filter','baselayer','singletile','maxzoomlevel');
?>
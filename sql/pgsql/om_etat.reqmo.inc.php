...
$ent=_('om_etat');
$reqmo['sql']="select  [om_etat], [om_collectivite], [id], [libelle], [actif], [orientation], [format], [logo], [logoleft], [logotop], [titre_om_htmletat], [titreleft], [titretop], [titrelargeur], [titrehauteur], [titrebordure], [corps_om_htmletatex], [om_sql], [se_font], [se_couleurtexte], [margeleft], [margetop], [margeright], [margebottom] from ".DB_PREFIXE."om_etat  order by [tri]";
...
$reqmo['tri']=array('om_etat','om_collectivite','id','libelle','actif','orientation','format','logo','logoleft','logotop','titre_om_htmletat','titreleft','titretop','titrelargeur','titrehauteur','titrebordure','corps_om_htmletatex','om_sql','se_font','se_couleurtexte','margeleft','margetop','margeright','margebottom');
?>
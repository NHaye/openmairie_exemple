...
$libtitre='Liste openexemple.om_sig_map'; // libelle titre
...
$l0=33; // largeur colone -> champs 0 - om_sig_map
...
$sql="select om_sig_map, om_collectivite, id from ".DB_PREFIXE."om_sig_map";
?>
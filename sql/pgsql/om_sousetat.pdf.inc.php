...
$libtitre='Liste openexemple.om_sousetat'; // libelle titre
...
$l0=33; // largeur colone -> champs 0 - om_sousetat
...
$sql="select om_sousetat, om_collectivite, id from ".DB_PREFIXE."om_sousetat";
?>
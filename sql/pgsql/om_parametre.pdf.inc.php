...
$libtitre='Liste openexemple.om_parametre'; // libelle titre
...
$l0=22; // largeur colone -> champs 0 - om_parametre
...
$sql="select om_parametre, libelle from ".DB_PREFIXE."om_parametre";
?>
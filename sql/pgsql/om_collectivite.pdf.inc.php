<?php
//$Id: om_collectivite.pdf.inc.php 1080 2012-02-25 15:33:52Z atreal $ 
...
$libtitre='Liste public.om_collectivite'; // libelle titre
...
$l0=40; // largeur colone -> champs 0 - om_collectivite
...
$a1='L';
$l2=140; // largeur colone -> champs2 - niveau
$be2='LR';// border entete colone
$b2='LR';// border cellule colone
$ae2='C'; // align cellule entete colone
$a2='L';
$widthtableau=280;
$bt=1;// border 1ere  et derniere ligne  du tableau par page->0 ou 1
$sql="select om_collectivite, libelle, niveau from ".DB_PREFIXE."om_collectivite";
?>
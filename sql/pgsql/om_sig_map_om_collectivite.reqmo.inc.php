...
$ent=_('om_sig_map_om_collectivite');
$reqmo['sql']="select  [om_sig_map], [id], [libelle], [actif], [zoom], [fond_osm], [fond_bing], [fond_sat], [layer_info], [etendue], [projection_externe], [url], [om_sql], [maj], [table_update], [champ], [retour], [type_geometrie], [lib_geometrie] from ".DB_PREFIXE."om_sig_map where om_collectivite = '[om_collectivite]' order by [tri]";
...
$reqmo['tri']=array('om_sig_map','id','libelle','actif','zoom','fond_osm','fond_bing','fond_sat','layer_info','etendue','projection_externe','url','om_sql','maj','table_update','champ','retour','type_geometrie','lib_geometrie');
?>
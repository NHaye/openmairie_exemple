<?php
/**
 * Ce script permet d'interfacer le traitement de suppression des fichiers 
 * générés d'une table.
 *
 * @package openmairie_exemple
 * @version SVN : $Id: gensup.php 2926 2014-10-13 13:20:24Z fmichon $
 */
...
$f = new utils(
    null,
    "gen",
    _("administration")." -> "._("generateur")." -> "._("suppression")
);
...
echo "<form method=\"post\" action=\"gensup.php?table=".$table."\" name=\"f1\">\n";
...
$f->layout->display_form_button(array(
    "value" => sprintf(_("supprimer les fichiers de la table : %s"), $table),

 ...
 * @version SVN : $Id: om_lettretype.class.php 3008 2015-01-15 08:47:18Z fmichon $
 */
 ...
 *
 */
class om_lettretype_core extends om_lettretype_gen {
    ...
    function verifieractif($id, $val) {
        ...
        if ($nbligne > 0) {
            $this->correct = false;
            $msg = $nbligne." ";
            $msg .= _("lettre(s) type existante(s) dans l'etat actif. Il ".
                      "n'est pas possible d'avoir plus d'une lettre type");
            $msg .= " \"".$val["id"]."\" "._("active par collectivite.");
    ...
    function view_edition() {
        ...
        $location = sprintf(
            "location:../pdf/pdflettretype.php?obj=%s",
            $obj
        );
